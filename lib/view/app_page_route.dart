...
///缩放效果
class PageRouteZoom extends PageRouteBuilder {
  final Widget widget;
  final int durationTime;
  final bool opaque;

  PageRouteZoom(this.widget,
      {this.durationTime = DURATION_TIME, this.opaque = true})
      : super(
          opaque: opaque,
...
///旋转+缩放效果
class PageRouteRotateZoom extends PageRouteBuilder {
  final Widget widget;

  PageRouteRotateZoom(this.widget)
      : super(
          transitionDuration: const Duration(seconds: 1),
          pageBuilder: (
            BuildContext context,
...
///滑动效果[MaterialPageRoute],[CupertinoPageRoute]
class PageRouteSlide extends PageRouteBuilder {
  final Widget widget;
  final int durationTime;

  PageRouteSlide(this.widget, {this.durationTime = DURATION_TIME})
      : super(
          transitionDuration: Duration(milliseconds: durationTime),
          pageBuilder: (
            BuildContext context,
...
const Color _kModalBarrierColors = CupertinoDynamicColor.withBrightness(
...
class CommonPageRoute<T> extends PageRoute<T> {
...
Future<T> showCupertinoModalPopup<T>({
  ...
  return Navigator.of(context, rootNavigator: useRootNavigator).push(
    _CupertinoModalPopupRoute<T>(
      barrierColor: CupertinoDynamicColor.resolve(_kModalBarrierColors, context),

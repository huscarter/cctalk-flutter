...
class AppEditableText extends StatefulWidget {
  ...
  @override
  AppEditableTextState createState() => AppEditableTextState();
...
class AppEditableTextState extends State<AppEditableText> with AutomaticKeepAliveClientMixin<AppEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<AppEditableText> implements TextInputClient, TextSelectionDelegate {
  Timer _cursorTimer;
...
// State lifecycle:
  ...
  @override
  void didUpdateWidget(AppEditableText oldWidget) {
...
class _AppEditable extends LeafRenderObjectWidget {
  const _AppEditable({
    Key key,
    this.textSpan,
    this.value,
